...
abstract class Ridings_WP_List_Table_Abstract extends \WP_List_Table
{
    protected $nonce;
    ...
    public function __construct($args = array())
    {
        ...
        $this->controller   = preg_replace('/(Ridings_)(\w+)(_WP_List_Table)/', '$2_Controller', static::class);
    ...
    function get_columns()
    {
        ...
        error_log(__CLASS__ . '->' . __LINE__ . '->get_columns: ' . print_r($columns, true));
        return $columns;
    }
    ...
    function prepare_items()
    {
        ...
        if (($_REQUEST['s'] ?? null) && $nonce_ok) {
            ...
            // error_log(__CLASS__ . '->' . __LINE__ . '->search:' . is_callable(($search_request)) . '#');
            ...
            // error_log(__CLASS__ . '->' . __LINE__ . '->read:' . is_callable(($read_request)) . '#');
        ...
        // error_log(__CLASS__ . '->' . __LINE__ . '->get_row_cnt:' . is_callable(($get_row_cnt_request)) . '#');
